...
namespace ShopOnline.Api.Repositories
{
    public class ShoppingCartRepository : IShoppingCartRepository
    {
        ...
        {
            return await this.shopOnlineDbContext.CartItems
        ...
        public async Task<CartItem> DeleteItem(int id)
        {
            ...
            throw new Exception("not found item to delete" + id);
        ...
        public async Task<CartItem> UpdateQty(int id, CartItemToUpdateDto cartItemToUpdateDto)
        {
            var item = await this.shopOnlineDbContext.CartItems.FindAsync(id);
            if (item == null) throw new Exception("item not found");
            item.Qty = cartItemToUpdateDto.Qty;
            shopOnlineDbContext.CartItems.Update(item);
            await shopOnlineDbContext.SaveChangesAsync();
            return item;
        }
    }
